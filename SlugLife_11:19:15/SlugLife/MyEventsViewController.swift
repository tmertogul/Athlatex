...
class MyEventsViewController: PFQueryTableViewController {
    ...
    */
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath, object: PFObject!) -> PFTableViewCell? {
        // 1
        let cell = tableView.dequeueReusableCellWithIdentifier("wallPostCell", forIndexPath: indexPath) as!EventPostTableViewCell
